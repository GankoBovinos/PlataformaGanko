...
)
{
    ...
    constructor(id_bovino: String, imagen: String?, name: String?, fecha: Date, genero: String, proposito: String, peso: Int,
                color: String?, raza: String?, id_madre: String?, id_padre: String?, salida: String?, lote: String?,
                salida_por: String?, numero_partos: Int?, parto_fallo: String?, fecha_salida: Date?, finca: Int, usuario: Int,
