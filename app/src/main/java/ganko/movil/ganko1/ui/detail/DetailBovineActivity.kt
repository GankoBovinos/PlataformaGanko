...
import ganko.movil.ganko1.ui.detail.feed.FeedBovineFragment.Companion.id
...
class DetailBovineActivity : AppCompatActivity(), HasSupportFragmentInjector {
    ...
    val id: Int by lazy { intent.extras.getInt(ID_BOVINE) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (content){
            ...
            CONTENT_FEED -> putFragment(R.id.container, FeedBovineFragment.instance(id))
            CONTENT_HEALTH -> putFragment(R.id.container, HealthBovineFragment.instance(id))
            CONTENT_MANAGE -> putFragment(R.id.container, ManageBovineFragment.instance(id))
            CONTENT_MEAT -> putFragment(R.id.container, MeatBovineFragment.instance(id))
            CONTENT_MILK -> putFragment(R.id.container, MilkBovineFragment.instance(id))
            CONTENT_MOVEMENTS -> putFragment(R.id.container, MovementsBovineFragment.instance(id))
            CONTENT_VACCINATION -> putFragment(R.id.container, VaccinationBovineFragment.instance(id))
        }
    }
